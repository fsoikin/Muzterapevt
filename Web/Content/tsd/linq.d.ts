...
declare module linqjs {
	...
	interface IEnumerable<T> {
		...
		groupJoin<TInner, TKey, TResult, TCompare>(inner: IEnumerable<TInner>, outerKeySelector: (outer: T) => TKey, innerKeySelector: (inner: TInner) => TKey, resultSelector: (outer: T, inner: IEnumerable<TInner>) => TResult, compareSelector?: (obj: TKey) => TCompare): IEnumerable<TResult>;
		groupJoin<TInner, TKey, TResult, TCompare>( inner: { length: number;[x: number]: TInner; }, outerKeySelector: ( outer: T ) => TKey, innerKeySelector: ( inner: TInner ) => TKey, resultSelector: ( outer: T, inner: IEnumerable<TInner> ) => TResult, compareSelector?: ( obj: TKey ) => TCompare): IEnumerable<TResult>;
		groupJoin<TInner, TKey, TResult, TCompare>( inner: TInner[], outerKeySelector: ( outer: T ) => TKey, innerKeySelector: ( inner: TInner ) => TKey, resultSelector: ( outer: T, inner: IEnumerable<TInner> ) => TResult, compareSelector?: ( obj: TKey ) => TCompare): IEnumerable<TResult>;
		all(predicate: (element: T) => boolean): boolean;
		any(predicate?: (element: T) => boolean): boolean;
		isEmpty(): boolean;
		concat<U extends T>(...sequences: IEnumerable<U>[]): IEnumerable<T>;
		concat<U extends T>(...sequences: { length: number;[x: number]: U; }[]): IEnumerable<T>;
		concat<U extends T>(...sequences: U[]): IEnumerable<T>;
